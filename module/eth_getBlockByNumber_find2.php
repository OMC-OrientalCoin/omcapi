...
*/
	...
	$_getBlockNumber  =  @$_GET['BlockNumber'];

	$_tmpValue = substr($_getBlockNumber, 0,1);
	$_BlockNumber =  $_tmpValue == "0x" ? $_getBlockNumber : "0x".$_getBlockNumber; 
 //$_BlockNumber = "0x".$_BlockNumber;
